    ...
    >
      ...
      {isModalOpen && selectedUser && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-slate-800 w-full max-w-5xl rounded-3xl px-6 py-8 relative">
              ...
              <div className="w-full md:w-2/3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                  ...
                  <div className="p-4 bg-gray-100 rounded-xl text-center">
                    <h3 className="font-bold">{selectedUser.totalViews || 0}</h3>
                    <p>Total Views</p>
                  </div>

                  <div className="p-4 bg-gray-100 rounded-xl text-center">
                    <h3 className="font-bold">{selectedUser.totalBlogs || 0}</h3>
                    <p>Blogs</p>
                  </div>

                  <div className="p-4 bg-gray-100 rounded-xl text-center">
                    <h3 className="font-bold">{selectedUser.comments || 0}</h3>
                    <p>Comments</p>
                  </div>

                  <div className="p-4 bg-gray-100 rounded-xl text-center">
                    <h3 className="font-bold">{selectedUser.likes || 0}</h3>
                    <p>Likes</p>
                  </div>
